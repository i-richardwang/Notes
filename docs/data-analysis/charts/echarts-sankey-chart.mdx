...
数据集的样本如下，每一行代表一个员工在不同年份的状态，数据集构造的过程参考笔记 [模拟员工入职三年的成长与保留](../dataprocessing/fictional-employee-development-dataset)。
...
![员工发展情况桑基图](/data-analysis-assets/visualization/echarts-sankey-chart.webp)