...
![tableau_layout_1](/data-analysis-assets/tableau/tableau_layout_1.png)
...
本案例的数据集生成过程请参考[以员工晋升记录为例虚构数据集](../dataprocessing/fictional-promotion-dataset)。
:::

![tableau_layout_2](/data-analysis-assets/tableau/tableau_layout_2.png)

**页面三**

![tableau_layout_3](/data-analysis-assets/tableau/tableau_layout_3.png)
...
![tableau_layout_4](/data-analysis-assets/tableau/tableau_layout_4.gif)
