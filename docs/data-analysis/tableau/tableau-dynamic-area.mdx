...
![tableau_dynamic_area](/data-analysis-assets/tableau/tableau_dynamic_area.gif)
...
![tableau_buttonfilter](/data-analysis-assets/tableau/tableau_buttonfilter.png)

当然，为了实现精妙的控制，需要很多细节上的优化。本例中，在展开与收起的不同状态下，控件的图标、说明文本、鼠标悬停显示的提示，都是不同的，这就需要多个参数和操作联动才能现实。

![tableau_dynamic_area_button](/data-analysis-assets/tableau/tableau_dynamic_area_button.png)
