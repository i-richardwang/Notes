...
![custom-color-palette](/data-analysis-assets/tableau/tableau-palette.webp)

应用到图表上的效果如下，对比默认调色板，自定义调色板更加柔和美观。

![custom-color-palette-demo](/data-analysis-assets/tableau/tableau-palette-demo.webp)
