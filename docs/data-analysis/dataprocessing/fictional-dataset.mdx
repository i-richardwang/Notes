...
3. [虚构员工连续两年的绩效评分](../charts/plotly-sankey-chart#构造数据集)
4. [虚构企业敬业度调研结果](../charts/tableau-scatter#数据集构造)
5. [虚构企业员工的年龄分布](../charts/plotly-box-violin#构造数据集)
6. [虚构员工的星座分布](../charts/nightingale-chart#构造数据集)
7. [虚构组织网络数据集](../charts/network-diagram#构造数据集)
