...
1. 数据库连接
    ...
    ![metabase-data-connection](/self-hosted-assets/metabase-data-connection.webp)
...
2. 低代码方式创建问题
    ...
    ![metabase-create-question](/self-hosted-assets/metabase-create-question.webp)

3. SQL方式创建问题

    当然，我们也可以直接使用 SQL 语句创建问题。

    ![metabase-create-question-sql](/self-hosted-assets/metabase-create-question-sql.webp)

4. 仪表板

    最后，将创建的问题添加到仪表板中，以便集中展示所有相关的数据视图。

    ![metabase-dashboard](/self-hosted-assets/metabase-dashboard.webp)
